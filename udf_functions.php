...
if (!defined('udf_functions')) {
    ...
    function udf_add_file_form()
    {
        ...
        foreach ($result as $row) {
            ...
            echo '<label class="control-label">' . e::h($row[2]) . '</label>';
            ...
            if ($row[1] == 2) {
                ...
                foreach ($sub_result as $sub_row) {
                    echo '<label class="radio"><input type=radio name="'. e::h($row[0]) .'" value="'. e::h($sub_row[0]) .'">'. e::h($sub_row[1]) . '</label>';
                }
            }
    ...
    function udf_edit_file_form()
    {
        ...
        foreach ($result as $row) {
            if ($row[1] == 1 || $row[1] == 2) {
                ...
                foreach ($sub_result as $sub_row) {
                    if ($row[1] == 1) {
                        ...
                        echo '<label class="radio"><input type=radio name="' . e::h($row[2]) . '" value="' . e::h($sub_row[0]) . '"';
                        if ($sel == $sub_row[0]) {
                            echo ' checked';
                        }
                        echo '>' . e::h($sub_row[1]) . '</label>';
                    }
                }
                if ($row[1] == 1) {
                    echo '</select>';
            ...
            elseif ($row[1] == 4) {
                ...
                //secondary dropdown
                echo '<div id="txtHint'. e::h($field_name) .'">';
    ...
    function udf_details_display($fileId)
    {
        ...
        foreach ($result as $row) {
            if ($row[1] == 1 || $row[1] == 2) {
                ...
                if ($stmt->rowCount() > 0) {
                    $return_string .= '<td class="title">' . e::h($row[0]) . ':</td><td>' . e::h($sub_row[0]) . '</td></tr>';
                }
            } elseif ($row[1] == 3) {
    ...
    function udf_functions_search_options()
    {
        ...
        foreach ($result as $row) {
            ...
            echo "<tr><td valign=\"top\"><b>$display</b></td><td>";
            ...
            if (3 === (int)$row[2]) {
                ...
                foreach($stmt->fetchAll() as $row_udf) {
                    $selected = $value == $row_udf[0] ? "selected" : "";
                    echo "<option value=\"{$row_udf[0]}\" {$selected}>{$row_udf[1]}</option>";
                }
