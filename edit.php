...
if (!isset($_REQUEST['submit'])) {
    ...
    if (isset($_REQUEST['rb_id'])) {
        $filedata->rb_id = (int)$_REQUEST['rb_id'];
    } else {
        $filedata->rb_id = null;
    }

    if (isset($_REQUEST['rb_operacion_id'])) {
        $filedata->rb_operacion_id = (int)$_REQUEST['rb_operacion_id'];
    } else {
        $filedata->rb_operacion_id = null;
    }
