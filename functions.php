...
function sort_browser()
{
    ...
    <script type="text/javascript">
        ...
        function load(select_box) {
            window.location = "search.php?submit=1&sort_by=id&where=" + category_option + "&sort_order=" + select_box.options[select_box.selectedIndex].value + "&keyword=" + escape(category_item_option) + "&exact_phrase=on";
        }
        <?php
        ///////////////////////////////FOR AUTHOR///////////////////////////////////////////
        $query = "
