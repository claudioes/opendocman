...
// $dsn = "mysql:host=" . DB_HOST . ";dbname=" . MAZDEN_DB_NAME . ";charset=utf8";
// try {
//     $pdoMazden = new PDO($dsn, DB_USER, DB_PASS);
// } catch (PDOException $e) {
//     print "Error!: " . $e->getMessage() . "<br/>";
//     die();
// }
// $pdoMazden->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
